...
def test_known_character(talker):
    ...
    assert (
        cap.resource_uri.__str__() == "http://gateway.marvel.com/v1/public/characters/1009220"
    )
    assert (
        cap.thumbnail.__str__()
    ...
    assert (
        cap.comics[0].resource_uri.__str__()
    ...
    assert (
        cap.series[10].resource_uri.__str__()
        == "http://gateway.marvel.com/v1/public/series/9865"
    )
